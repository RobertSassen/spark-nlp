...
import com.johnsnowlabs.nlp.embeddings.{ClusterWordEmbeddings, WordEmbeddingsIndexer, WordEmbeddingsRetriever}
...
object NerDLCoNLL2003 extends App {
  ...
  val embeddings = new ClusterWordEmbeddings(wordEmbeddignsFile, wordEmbeddingsDim, caseSensitive=false)
